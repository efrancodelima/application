...
public interface IntClienteApi {
   ...
   */
  @Operation(summary = "Cadastrar cliente", description = ClienteConstantes.DESC_CADASTRAR)
  @ApiResponses(value = {
    @ApiResponse(responseCode = "201", description = ClienteConstantes.D201, 
      content = @Content(mediaType = "application/json", examples = @ExampleObject(
        value = ClienteConstantes.E201))),

    @ApiResponse(responseCode = "400", description = ClienteConstantes.D400,
      content = @Content(mediaType = "application/json", examples = @ExampleObject(
        value = ClienteConstantes.E400))),
    
    @ApiResponse(responseCode = "422", description = ClienteConstantes.D422,
      content = @Content(mediaType = "application/json", examples = @ExampleObject(
        value = ClienteConstantes.E422))),
    
    @ApiResponse(responseCode = "500", description = ClienteConstantes.D500,
      content = @Content(mediaType = "application/json", examples = @ExampleObject(
        value = ClienteConstantes.E500))) })
   ...
   * @throws Exception Exceção lançada pela operação.
   */
  @Operation(summary = "Buscar cliente por CPF", description = ClienteConstantes.DESC_BUSCAR)
  @Parameter(name = "cpf", description = "CPF do cliente", required = true)
  
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = ClienteConstantes.D200,
      content = @Content(mediaType = "application/json", examples = @ExampleObject(
        value = ClienteConstantes.E200))),

    @ApiResponse(responseCode = "400", description = ClienteConstantes.D400,
      content = @Content(mediaType = "application/json", examples = @ExampleObject(
        value = ClienteConstantes.E400))),

    @ApiResponse(responseCode = "404", description = ClienteConstantes.D404,
      content = @Content(mediaType = "application/json", examples = @ExampleObject(
        value = ClienteConstantes.E404))),
